...
plt.scatter(data.index, data['Buy Signals'], label = 'Buy Signal', marker = '^', c = 'green', s =100)
plt.scatter(data.index, data['Sell Signals'], label = 'Sell Signal', marker = 'v', c = 'red', s = 100)
plt.legend(loc = 'upper left')
plt.show()